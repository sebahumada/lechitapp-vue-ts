<template>
    <form @submit.prevent="handleSubmit">
                      ...
                      <div class="form-floating mb-3">
                        <input type="number" name="cantidad" id="flCantidad"  v-model="form.cantidad" min="0" max="999" class="form-control" />
                        <label htmlFor="flCantidad">Ingresa Cantidad (ml)</label>            
                      </div>

                      <div class="form-floating mb-3">
                        <input type="date" name="fecha" id="flFecha" v-model="form.fecha" :min="semana" :max="hoy" class="form-control" />
                      ...
                      <!-- <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" checked={nocturno} name="nocturno" />
                        <label class="form-check-label" htmlFor="flexSwitchCheckDefault">Leche nocturna</label>
                      </div>  -->

                        <button type="submit" class="btn btn-success mt-2 "><i className="fas fa-save"></i> {{ tipo }}</button>
                    </form>
</template>
